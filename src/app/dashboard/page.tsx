...
function SwimmerIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M2 17 Q5 15 8 17 Q11 19 14 17 Q17 15 20 17 Q23 19 25 17" stroke="#3b82f6" strokeWidth="1.8" strokeLinecap="round" fill="none" opacity="0.6" />
    </svg>
  );
}
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <SwimmerIcon />
            <h2 className="text-base font-bold text-gray-800">יומן אימונים</h2>
          </div>
          <Link
