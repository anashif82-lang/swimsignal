...
export default async function CalendarPage({ searchParams }: Props) {
  ...
  return (
    <div className="p-4 md:p-6 h-full flex flex-col gap-4 pb-24">
      <div className="shrink-0">
        <h1 className="text-xl font-bold" style={{ color: "#0F172A" }}>לוח שנה</h1>
        <p className="text-sm mt-0.5" style={{ color: "#94A3B8" }}>תכנן את האימונים שלך</p>
      </div>
